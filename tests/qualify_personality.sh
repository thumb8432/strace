...
[ 2 -le "$#" ] || \
	fail_ "No personality designation (\"64\", \"32\", \"x32\") provided"
...
pers_found=0
for i in $(echo "$supported_pers"); do
...
# If tested personality is not equivalent to curernt personality, reset $NAME,
